...
const Gallery = () => {
  ...
  const { isVisible } = useStaticSectionSettings("gallery");
  const { data: pageBlocks = [], isLoading: blocksLoading } = usePageBlocks("gallery");
  ...
  const showGalleryGrid = isVisible("static_gallery_grid");
