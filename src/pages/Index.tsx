...
import {
  ...
  Layers, Printer, Package, CheckCircle, HelpCircle, ChevronDown
} from "lucide-react";
          ...
          >
            {[
              ...
              >
                ...
                <span className="absolute -top-2 left-1/2 -translate-x-1/2 font-display text-5xl font-bold text-primary/10">
                  {step}
                </span>
