...
export default function EmailLivePreview({ template: t }: Props) {
  ...
  const replacePlaceholders = (text: string) => {
    const map: Record<string, string> = {
      ...
      '{{order_items_table}}': '1× Custom Dragon Figurine — 280 kr\n1× Lithophane Night Lamp — 170 kr',
      ...
      '{{request_fee}}': '100 kr',
      '{{quoted_price}}': '350 kr',
      '{{custom_request_summary}}': 'Custom dragon figurine with detailed scales, mounted on a wooden base. Approximately 15 cm tall.',
      '{{uploaded_files}}': 'dragon_v3.stl (4.2 MB)',
